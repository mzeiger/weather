...
''';
const String txt2 = '''
You may also use a browser that is not on you phone to obtain and copying the key 
    ...
    return const Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
              'This FREE key may be obtained by going to https://visualcrossing.com.'),
          Text(
            txt1,
            softWrap: true,
          ...
          Text('Now click on the "NEXT" button below for instructions.')
        ],
      ),
    );
  }
